...
export function CreateProject() {
  return (
    <Link
      ...
      className="flex h-10 items-center rounded-lg bg-secondary-foreground px-4 text-sm font-medium text-secondary transition-colors hover:bg-secondary hover:text-secondary-foreground focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
    >
